...
class App extends Component {
  ...
  notRented = (id) => {
    ...
    this.setState({ moviesData: movies }, function () {
    ...
    return (
      <Router>
        <div className="App"><div id="home-background"></div><div id="main-links">
          ...
          <Route path="/catalog" exact render={() => <Catalog isRented={this.isRented} moviesData={this.state.moviesData} notRented={this.notRented} />} />
          <Route path="/landing" exact render={() => <Landing />} />
          <Route path="/movies/:movieId" exact render={({ match }) => <MovieDetail match={match} moviesData={this.state.moviesData} />} />
